...
class Subito:
    ...
    def search(
        ...
        while (
            i <= results
        ):  ## the REST API gives maximum 100 results, we need to manipulate the request by using a loop to get more
            ...
            results_list = (
                results_list + response["ads"]
            )  ## append the result of each request
            print(querystring)
            i += 100
